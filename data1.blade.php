  ...
  <div class="modal-dialog">
    ...
    <div class="col-md-6" >
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button  class="text-center" type="submit"  name="submit">Input</button>
        </form>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="input{{$s->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button class="btn btn-primary"  value="{{$s -> Jam_masuk='value:true'}}" type="submit"  name="submit" >Isi</button>
      </div>
      </form>
    </div>
    </div>
...
INSERT INTO siswa VALUES('',new.Nama,new.Kelas,
                           new.Jurusan,
                         new.Jenis_kelamin,new.Alasan,NOW(),
